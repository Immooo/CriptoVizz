...
Dernière mise à jour : 9 septembre 2026 à 13 h 08  
Reprise prévue : 9 septembre vers 14 h 30–15 h  
...
|---|---:|---|---|
| Présentation fonctionnelle du projet | 🟠 | RSS, sentiment, topics et Grafana sont cités | Commencer par le besoin et supprimer les répétitions |
| Parcours complet d'un article | 🟠 | Ordre général et deux queues compris | Dire articles, préciser chaque producteur/consumer et éviter l'API inexistante |
...
| Montée en charge | 🟠 | `prefetch_count=50` connu | Expliquer qu'il limite les messages non acquittés et citer les autres goulots |
...
### Tes priorités avant la soutenance

1. Rendre le parcours d'un article parfaitement exact et fluide.
2. Maîtriser les scénarios de panne et la différence durable/persistent/ACK.
3. Défendre l'orientation Big Data sans exagérer le volume actuel.
4. Expliquer la scalabilité au-delà du seul `prefetch_count`.
5. Répondre en 30 à 45 secondes avec une structure stable.
...
| 14:45–15:30 | 45 min | **Bloc 1 — architecture** : dessin fermé, puis questions 2, 3, 6, 8 et 14 | Pipeline exact en moins de 2 min |
| 15:30–15:40 | 10 min | Pause debout, sans contenu technique | Reprise à l'heure |
| 15:40–16:25 | 45 min | **Bloc 2 — RabbitMQ** : questions 16 à 28, priorité 16, 18, 23 et 27 | Expliquer durable/persistent/ACK/prefetch sans confusion |
| 16:25–16:40 | 15 min | Pause, collation légère | — |
| 16:40–17:25 | 45 min | **Bloc 3 — Big Data et scale** : questions 41, 42, 46, 47, 48 et 50 | Réponse Big Data honnête + charge ×100 en 60 s |
| 17:25–17:40 | 15 min | Pause et repos vocal | — |
| 17:40–18:25 | 45 min | **Simulation PowerPoint n°1**, debout et chronométrée | Noter durée et trois erreurs maximum |
| 18:25–19:10 | 45 min | Grande pause et repas | Couper réellement avec le projet |
| 19:10–19:40 | 30 min | Corriger uniquement les trois erreurs de la simulation | Chaque passage faible refait deux fois |
| 19:40–19:50 | 10 min | Pause | — |
| 19:50–20:35 | 45 min | **Démo réelle + plan B** : services, RabbitMQ, Grafana, captures | Démo entre 3 et 5 min sans improvisation |
| 20:35–20:45 | 10 min | Pause | — |
| 20:45–21:25 | 40 min | **Jury mixte** : 10 questions tirées parmi les niveaux 2 et 3 | Au moins 7 réponses notées 2 ou 3 |
...
| 15 | Pourquoi Docker Compose ? | Lancement reproductible, isolation, réseaux, volumes | 🟡 | ⬜ | ⬜ | ⬜ |
...
| 35 | D'où part la mesure de latence ? | `collected_at`, pas publication éditeur | 🟡 |
...
| 47 | Quels composants peuvent saturer à ×100 ? | Analyse CPU, RabbitMQ, Storage/transactions, MySQL, Grafana | 🟠 |
...
|---|---:|---:|---:|---|
| Pitch et valeur | 1.5 |  | 2.5 | Refaire le pitch trois fois avec des mots différents |
| Architecture | 2.0 |  | 3.0 | Dessiner queues v3, ACK, DLQ et tables |
| RabbitMQ | 2.3 |  | 3.0 | Travailler panne broker et publication avant ACK |
| MySQL/idempotence | 1.5 |  | 2.5 | Expliquer transaction et doublon après redelivery |
| Analytics | 1.8 |  | 2.5 | Donner méthode, exemple et deux limites |
| Big Data | 1.5 |  | 2.5 | Réponse 4V honnête + évolution industrielle |
| Scalabilité | 1.5 |  | 2.5 | Distinguer prefetch et ajout de replicas |
| Grafana/observabilité | 1.8 |  | 2.5 | Nommer les six panneaux et leur utilité |
| Démo |  |  | 2.5 | Faire une démo nominale et une dégradée |
| Expression orale | 1.7 |  | 2.5 | Réduire tics de langage et annoncer la structure |
...
### Prochaine séance à lancer immédiatement

1. Fermer ce document.
2. Dessiner l'architecture complète en cinq minutes.
3. Répondre aux questions 3, 16, 23, 27, 41 et 47.
4. Noter chaque réponse de 0 à 3.
5. Relire seulement les réponses ayant obtenu 0 ou 1.
6. Refaire ces réponses après le bloc PowerPoint.
